...
public class LearnerDataLoader {
    ...
    public void loadData() {
        ...
        learnerRepository.save(new Learner("John", "Wick", "johnwick@continental.com", "12345678"));
        learnerRepository.save(new Learner("Winston", "Scott", "winstonscott@continental.com", "22345678"));
        learnerRepository.save(new Learner("Viggo", "Tarasov", "viggotarasov@continental.com", "32345678"));
    }
